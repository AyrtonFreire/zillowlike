...
const DEFAULT_CARDS: Card[] = [
  ...
  {
    key: "realtor",
    href: "/para-profissionais#corretor",
    title: "Sou corretor(a)",
    desc: "Veja a jornada ideal para ativar seu perfil profissional, configurar apresentação pública e começar com um painel simples de leads.",
  ...
  {
    key: "agency",
    href: "/para-profissionais#imobiliaria",
    title: "Sou uma imobiliária",
    desc: "Entenda quando faz sentido abrir um workspace da empresa, centralizar o time e operar como agência com CNPJ próprio.",
