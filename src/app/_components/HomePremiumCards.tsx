...
const DEFAULT_CARDS: Card[] = [
  ...
  },
  {
    ...
    desc: "Centralize seus leads, acompanhe o funil e responda mais rápido pelo painel do corretor. Se optar, você também pode receber interessados vindos de anúncios de proprietários.",
  ...
  },
  {
    ...
    desc: "Tenha um painel do time: pipeline, distribuição de leads, gestão de corretores e visão de desempenho em um só lugar.",
    cta: "Conhecer painel da imobiliária",
    accent: "slate",
