    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        <div className="max-w-3xl">
          <p className="text-xs sm:text-sm font-semibold tracking-[0.18em] text-teal-600 uppercase">Previews</p>
          <h1 className="mt-3 text-3xl sm:text-4xl md:text-5xl font-display text-gray-900">
            Sessão “Para quem é o OggaHub”
          </h1>
          <p className="mt-3 text-sm sm:text-base text-gray-600">
            Abaixo estão 3 variações visuais usando o mesmo conteúdo. Escolha a que mais te agrada e eu aplico no
            `src/app/page.tsx`.
          </p>
        </div>
