...
export const PropertyCreateSchema = z
  ...
  details: z
    .object({
      ...
      builtAreaM2: z.number().int().min(0).max(1000000).nullable().optional(),
      lotAreaM2: z.number().int().min(0).max(1000000).nullable().optional(),
      privateAreaM2: z.number().int().min(0).max(1000000).nullable().optional(),
      usableAreaM2: z.number().int().min(0).max(1000000).nullable().optional(),
