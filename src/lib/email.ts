          ...
          <div class="wrapper">
            <div class="container">
              <div class="header">
                ...
                <p class="subtitle">Finalize a ativação da sua conta para liberar o acesso à plataforma.</p>
              </div>
              <div class="content">
                <div class="card">
                  <p class="paragraph">Olá${data.name ? `, <strong>${data.name}</strong>` : ""}!</p>
                  <p class="paragraph">Obrigado por se cadastrar no <strong>OggaHub</strong>. Para confirmar que este e-mail é seu e concluir o cadastro, clique no botão abaixo.</p>
                  <div class="button-wrapper">
                  ...
                  <p class="paragraph" style="margin-top:14px; font-size:11px; color:#9ca3af;">Se você não criou uma conta, pode ignorar este e-mail com segurança.</p>
                </div>
              </div>
              <div class="footer">
                <p>Para sua segurança, o time do <strong>OggaHub</strong> nunca irá pedir sua senha por e-mail ou mensagem.</p>
              </div>
            </div>
          </div>
        </body>
