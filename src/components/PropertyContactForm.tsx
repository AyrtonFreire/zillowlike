...
export default function PropertyContactForm({ propertyId, propertyTitle }: PropertyContactFormProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl shadow-lg">
      {/* Header */}
      <div className="glass-teal text-white p-6 rounded-t-2xl">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <button
          type="submit"
          disabled={sending}
          className="w-full flex items-center justify-center gap-2 glass-teal disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-lg transition-all transform hover:-translate-y-0.5 disabled:transform-none"
        >
          {sending ? (
            <>
