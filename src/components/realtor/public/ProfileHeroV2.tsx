...
interface ProfileHeroV2Props {
  ...
  shareAction: () => void;
  /**
   * Optional side card rendered as the right column in xl+. In <xl it does not
   * render (the Layout shows it as an inline block below the hero).
   */
  sideCard?: ReactNode;
}
...
export default function ProfileHeroV2({
  ...
  return (
    <section className="pt-10 pb-8 sm:pt-14 lg:pt-16 lg:pb-10">
      <div className="xl:grid xl:grid-cols-[minmax(0,1fr)_320px] xl:items-start xl:gap-10">
        ...
        {sideCard ? <div className="hidden xl:block">{sideCard}</div> : null}
      </div>
    </section>
  );
}
