...
export default function HeroSection() {
  ...
  return (
    <div className="relative min-h-[580px] sm:min-h-[70vh] md:min-h-[68vh] lg:min-h-[60vh] flex items-center justify-center overflow-visible pt-20 md:pt-0 pb-6 md:pb-0">
