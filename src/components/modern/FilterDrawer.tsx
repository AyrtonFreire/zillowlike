  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 z-40 glass-teal text-white p-4 rounded-full transition-all flex items-center gap-2"
      >
            ...
            >
              ...
              <div className="sticky bottom-0 bg-white border-t border-gray-200 p-6 flex gap-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleApply}
                  className="flex-1 py-3 glass-teal text-white rounded-xl font-semibold transition-all"
                >
                  Aplicar
                </motion.button>
              </div>
